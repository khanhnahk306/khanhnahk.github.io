const couses = [
    ...
    },
    {
        ...
        image:
            "https://media.techmaster.vn/api/static/bub3enc51co7s932dsk0/bjxnxQi0",
        type: "OnLab",
        rating: 4.7,
        content:
            "Swift là một trong những ngôn ngữ đang phát triển mạnh mẽ nhất hiện nay",
        topics: ["Backend", "Database"],
        supporterId: 3,
    },
    {
        ...
        image:
            "https://media.techmaster.vn/api/static/brbgh4451coepbqoch60/bt3miv451co41h2qcnr0",
        type: "OnLab",
        rating: 4,
        content:
            "Khoá học lập trình Arduino Scratch phù hợp cho trẻ em từ 08 đến 18 tuổi. Đội ngũ giảng viên Techmaster thiết kế khoá học",
        supporterId: 1,
    },
    {
        id: 5,
...
const supporters = [
    ...
    },
    {
        ...
        phone: "0987273764",
        avatar:
            "https://media.techmaster.vn/api/static/c2m5ou451cob24f6skeg/ccjlg0NC",
    },
];
